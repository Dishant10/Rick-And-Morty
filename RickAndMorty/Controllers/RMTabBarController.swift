...
final class RMTabBarController: UITabBarController {
   ...
   private func setUpTabs() {
       ...
       nav2.tabBarItem = UITabBarItem(title: "Episode", image: UIImage(systemName: "globe"), tag: 2)
       nav3.tabBarItem = UITabBarItem(title: "Location", image: UIImage(systemName: "tv"), tag: 3)
